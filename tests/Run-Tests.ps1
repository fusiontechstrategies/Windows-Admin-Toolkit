...
Test-ToolkitAssertion -Condition ($readmeText -match '\[complete signed ZIP\]\(https://github\.com/fusiontechstrategies/Windows-Admin-Toolkit/releases/latest\)' -and $readmeText -notmatch 'releases/tag/v3\.0\.1') -Name 'README points release downloads only at the current published release'
